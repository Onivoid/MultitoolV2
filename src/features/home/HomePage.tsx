...
import { RecentPatchNotes } from "@/features/patchnotes/components/RecentPatchNotes";
        ...
        <Card className="bg-background/40 lg:col-span-2">
          <CardContent className="pt-6">
            ...
            <p className="text-muted-foreground mt-2">
              Outils pour Star Citizen: traductions, gestion du cache, presets
              personnages et mises à jour.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <Link to="/traduction" className="block">
                <Button
                  variant="secondary"
                  className="w-full justify-start gap-2 hover:scale-[1.01] transition"
                >
        ...
        <Card className="bg-background/40">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Si vous venez de Multitool V1, les préférences de traduction V1 ne
              sont pas compatibles avec la V2. Pour repartir proprement,
              désinstallez puis réinstallez la traduction via l'onglet de
              Traductions.
            </p>
          </CardContent>
        </Card>
